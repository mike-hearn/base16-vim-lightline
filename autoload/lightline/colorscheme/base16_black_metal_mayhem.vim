...
let s:base0A = [ '#eecc6c',  3 ] " yellow
let s:base0B = [ '#f3ecd4',  2 ] " green
...
let g:lightline#colorscheme#base16_black_metal_mayhem#palette = lightline#colorscheme#flatten(s:p)
