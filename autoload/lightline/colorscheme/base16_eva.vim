...
let s:base0A = [ '#ffff66',  3 ] " yellow
let s:base0B = [ '#66ff66',  2 ] " green
let s:base0C = [ '#4b8f77',  6 ] " teal
let s:base0D = [ '#15f4ee',  4 ] " blue
...
let g:lightline#colorscheme#base16_eva#palette = lightline#colorscheme#flatten(s:p)
