...
let s:base0A = [ '#626b67',  3 ] " yellow
let s:base0B = [ '#a5aaa7',  2 ] " green
...
let g:lightline#colorscheme#base16_black_metal_marduk#palette = lightline#colorscheme#flatten(s:p)
