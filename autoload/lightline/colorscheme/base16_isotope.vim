...
let s:base04 = [ '#c0c0c0', 20 ]
let s:base05 = [ '#d0d0d0',  7 ]
let s:base06 = [ '#e0e0e0', 21 ]
let s:base07 = [ '#ffffff', 15 ] " white

let s:base08 = [ '#ff0000',  1 ] " red
let s:base09 = [ '#ff9900', 16 ] " orange
let s:base0A = [ '#ff0099',  3 ] " yellow
let s:base0B = [ '#33ff00',  2 ] " green
let s:base0C = [ '#00ffff',  6 ] " teal
let s:base0D = [ '#0066ff',  4 ] " blue
let s:base0E = [ '#cc00ff',  5 ] " pink
let s:base0F = [ '#3300ff', 17 ] " brown
