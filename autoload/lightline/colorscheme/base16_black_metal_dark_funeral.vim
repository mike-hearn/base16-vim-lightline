...
let s:base0A = [ '#5f81a5',  3 ] " yellow
let s:base0B = [ '#d0dfee',  2 ] " green
...
let g:lightline#colorscheme#base16_black_metal_dark_funeral#palette = lightline#colorscheme#flatten(s:p)
