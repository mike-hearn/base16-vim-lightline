let s:base00 = [ '#292d3e',  0 ] " black
let s:base01 = [ '#444267', 18 ]
let s:base02 = [ '#32374d', 19 ]
let s:base03 = [ '#676e95',  8 ]
let s:base04 = [ '#8796b0', 20 ]
let s:base05 = [ '#959dcb',  7 ]
let s:base06 = [ '#959dcb', 21 ]
...
let g:lightline#colorscheme#base16_material_palenight#palette = lightline#colorscheme#flatten(s:p)
