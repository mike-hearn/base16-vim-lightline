...
let s:base0A = [ '#99bbaa',  3 ] " yellow
let s:base0B = [ '#ddeecc',  2 ] " green
...
let g:lightline#colorscheme#base16_black_metal_burzum#palette = lightline#colorscheme#flatten(s:p)
