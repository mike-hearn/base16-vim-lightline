...
let s:base0A = [ '#e78a53',  3 ] " yellow
let s:base0B = [ '#fbcb97',  2 ] " green
...
let g:lightline#colorscheme#base16_black_metal_bathory#palette = lightline#colorscheme#flatten(s:p)
