...
let s:base0A = [ '#556677',  3 ] " yellow
let s:base0B = [ '#7799bb',  2 ] " green
...
let g:lightline#colorscheme#base16_black_metal_immortal#palette = lightline#colorscheme#flatten(s:p)
