...
let s:base0A = [ '#f79a0e',  3 ] " yellow
let s:base0B = [ '#538947',  2 ] " green
let s:base0C = [ '#4b8093',  6 ] " teal
let s:base0D = [ '#7cafc2',  4 ] " blue
let s:base0E = [ '#96609e',  5 ] " pink
...
let g:lightline#colorscheme#base16_mexico_light#palette = lightline#colorscheme#flatten(s:p)
